...
function MethodCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full rounded-2xl border border-border bg-card p-0 text-left transition hover:border-primary/40 hover:bg-accent/40"
    >
    ...
    if (method === "session") {
      return (
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-chart-4/30 bg-chart-4/12 p-4 text-sm leading-6 text-foreground">

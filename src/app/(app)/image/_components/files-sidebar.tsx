...
export function FilesSidebar({ initialFiles, onOpenImage }: FilesSidebarProps) {
  ...
  return (
    <aside className="order-3 max-h-[62dvh] w-full overflow-hidden rounded-2xl border border-stone-200/60 bg-gradient-to-b from-white to-stone-50/30 shadow-lg lg:order-none lg:h-full lg:max-h-none lg:min-h-0 dark:border-stone-700 dark:from-stone-900 dark:to-stone-800/30">

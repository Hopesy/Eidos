...
import { ArrowUp, ImagePlus, LoaderCircle, Trash2, Upload } from "lucide-react";
...
export function ComposerPanel({
    ...
    return (
        <div className="shrink-0 border-t border-stone-200 bg-white px-2 py-2 sm:px-3 sm:py-2.5">
            <div className="mx-auto flex max-w-[980px] flex-col gap-2">
                ...
                >
                    {sourceImages.length > 0 ? (
                        <div className="hide-scrollbar flex gap-2 overflow-x-auto border-b border-stone-200 px-3 py-2.5">
                    ...
                    <div className="px-2.5 pb-1 pt-2">
                        <Textarea
                            ...
                            className="min-h-[52px] max-h-[240px] resize-none border-0 bg-transparent !px-0 !pt-0.5 !pb-0.5 text-[15px] leading-6 text-stone-900 shadow-none placeholder:text-stone-400 focus-visible:ring-0 overflow-y-auto"
                        />
                    </div>

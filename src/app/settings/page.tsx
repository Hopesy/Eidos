                        ...
                        <ConfigSection title="图片与接入">
                            <div className="flex items-end gap-2 md:col-span-2">
                                <div className="flex-1">
                                    <LabelWithHint id="chatgpt-base-url" label="图像 API 地址" hint="默认使用 OpenAI 官方图像 API 地址" />
                                ...
                                <div className="flex-1">
                                    <LabelWithHint id="chatgpt-api-key" label="图像 API Key" hint="本地号池不可用时，自动回退到这里配置的图像服务" />
                                    <Input
                                        id="chatgpt-api-key"
                                        type="password"
                            ...
                            <div className="grid gap-3 md:col-span-2 md:grid-cols-2">
                                <Field
                                    ...
                                    label="图像 API 风格"
                                    hint="v1 Images 走 /v1/images/*；Responses 走 /v1/responses + image_generation 工具"
                                >
                                    <Select
